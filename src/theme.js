...
function getTheme({ theme, name }) {
  ...
  const onlyDark = (color) => {
    return themes({ dark: color, dark_high_contrast: color, dark_colorblind: color, dark_dimmed: color, dark_black: color })
  }
  ...
  const lightDark = (light, dark) => {
    return themes({ light: light, light_high_contrast: light, light_colorblind: light, dark: dark, dark_high_contrast: dark, dark_colorblind: dark, dark_dimmed: dark, dark_black: dark })
  }
  ...
  return {
      ...
      semanticTokenColors: {
          // Function declarations (like `const setIsVivaldi = ...`) get white/default foreground
          "function.declaration": color.fg.default,
          // Method declarations get the default foreground color to match GitHub
          "method.declaration": color.fg.default,
          // Function calls (like `useTabManagerStore()`) keep their purple color via tokenColors
          // Parameter declarations get the default foreground color to match GitHub
          "parameter.declaration": color.fg.default,
          // All parameters get the default foreground color to match GitHub
          parameter: color.fg.default,
          // Property accesses get blue color to match GitHub
          property: lightDark(scale.blue[6], scale.blue[2]),
          // Property declarations get blue color to match GitHub
          "property.declaration": lightDark(scale.blue[6], scale.blue[2]),
          // Default library classes (like Array, Object, etc.) get orange to match GitHub
          "class.defaultLibrary": lightDark(scale.orange[6], scale.orange[2]),
          // Default library variables (like localStorage, console, etc.) get default foreground to match GitHub
          "variable.defaultLibrary": color.fg.default,
          // Local readonly variables (const declarations like `const tabGroups = ...`) get default foreground to match GitHub
          "variable.readonly.local": color.fg.default,
      },
      tokenColors: [
          {
